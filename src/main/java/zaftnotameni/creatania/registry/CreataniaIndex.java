...
import static zaftnotameni.creatania.registry.CreativeModeTabs.Creatania;
//import static zaftnotameni.creatania.registry.CreativeModeTabs.creataniaCreativeTab;

public class CreataniaIndex {

  public static final CreataniaRegistrate CREATANIA_INDEX = CreataniaRegistrate.forMod(Constants.MODID).setCreativeTab(Creatania);
